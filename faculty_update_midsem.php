...
<form action="faculty_update_midsem.php" enctype="multiple/form-data" name="myform1" id="myform1" method="post">
...
<td><input type='text' name="midsem['<?php echo $row1['registration_no'];?>']" id="midsem['<?php echo $row1['registration_no']; ?>']"/></td>
</tr>
...
foreach ($_POST['midsem'] as $_id=>$_value)
{
echo $_id.'-'.$_value;
$query=mysql_query("UPDATE `". $tablename ."` SET midsem='$_value' WHERE registration_no=$_id")or die("Error: ". mysql_error());
}
