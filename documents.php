...
<form action="student_display.php" enctype="multiple/form-data" name="myForm" id="myform" method="post">
...
<a href='qualification_document_edit.php?pid=<?php echo $id;?>'>Qualification Edit</a></td>
</tr>
