...
<form action="faculty_update_grade.php" enctype="multiple/form-data" name="myform1" id="myform1" method="post">
...
<td><input type='text' name="grade['<?php echo $row1['registration_no'];?>']" id="grade['<?php echo $row1['registration_no']; ?>']"/></td>
</tr>
...
foreach ($_POST['grade'] as $_id=>$_value)
{
echo $_id.'-'.$_value;
$query=mysql_query("UPDATE `". $tablename ."` SET grade='$_value' WHERE registration_no=$_id")or die("Error: ". mysql_error());
}
